...
- the worker writes the structured review artifact to `.symphony/review.md`, which the runtime uses as the canonical source for durable review comment upsert
